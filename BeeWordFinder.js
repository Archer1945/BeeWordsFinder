...
//var dictionary =['aa','aachen','aardvark','aaron','abaci','abacus','abaft'];

// END USE WHEN DEBUGGING
...
//console.log('Center Letter = ' + mustContain);

// Letters Not In Words
...
for (var i = 0; i < letters.length; i++) {
   ...
   // console.log('i = ' + i);
    ...
    for (var j = 0; j < alphabet.length; j++) {
     ...
     //   console.log('letters-i bef if = ' + letters[i]);

     //   console.log('temp = ' + temp);

        if(letters[i]==temp[0]){

     //       console.log('letters-i aft if  = ' + letters[i]);
...
//console.log('Ltrs Not In Word' + ' = ' + alphabet);


// COMPARE ALPHABET (LETTERS NOT IN WORD) WITH DICTIONARY WORDS
...
for (var i = 0; i < dictionary.length; i++) {
   ...
   alplen = alphabet.length;

   dwrdlen = dictword.length;

   //console.log('dictword-i = ' + dictword);

   //console.log('dictionary.length-i = ' + dictionary.length);
   ...
   //console.log('alphabet length-i = ' + alphabet.length);

   //console.log('alplen-i = ' + alplen);

   //console.log('dwrdlen-i = ' + dwrdlen);
   ...
   k = 0;
    ...
    for (var j = 0; j < alplen; j++) {
       ...
       for (var k = 0; k < dwrdlen; k++) {

        var temp = dictword.split('');

        //console.log('alphabet-j bef if = ' + alphabet[j]);

        //console.log('temp-wrd-k = ' + temp);

        //console.log('temp-ltr-k = ' + temp[k]);
        ...
        //console.log('k-k = ' + k);
         ...
         if(alphabet[j]==temp[k]) {

            //console.log('alphabet-j aft if  = ' + alphabet[j]);

            dictionary.splice(i,1);

            //console.log('Possible Words in if' + ' = ' + dictionary);

            dwrdlen = 0;

            alplen =  0;

            //console.log('alplen-if = ' + alplen);

            //console.log('dwrdlen-if = ' + dwrdlen);
  ...
  // console.log('Possible Bee Words' + ' = ' + dictionary);

// MUST CONTAIN SPECIFIC LETTER

var gw = [];

 for (var m = 0; m < dictionary.length; m++) {
   //console.log('m-m = ' + m);
   dictword = dictionary[m];
   //console.log('dictword = ' + dictword);

   for (n = 0; n < dictword.length; n++) {
      var tempdltr = dictword.split('');
      //console.log('tempdltr = ' + tempdltr[n]);
      //console.log('mustContain = ' + mustContain);

      if(mustContain == tempdltr[n]) {
        //console.log('Good Word = ' + dictword);
        gw = 'GW';
        //console.log('m-if = ' + m);
        //console.log('gw = ' + gw);
        break;
...
if(gw == 'GW' && dictword.length >= 4) {
//console.log('It is a Good Word - ' + dictword);
//console.log('dictword len = ' + dictword.length);
gw = 'BW';
}
else {
//console.log('n-n = ' + n);
//console.log('m-n = ' + m);
//console.log('Bad dictionary word = ' + dictionary[m]);
...
//console.log('Finished m loop');

console.log('Possible Bee Words with Specific letter = ' + mustContain + ' = ' + dictionary);
